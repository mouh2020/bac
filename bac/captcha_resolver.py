...
def resolve_captcha(html_code) :
    captcha_resolver = Captcha(html_code)
    captcha_resolver.get_captcha_field()
    captcha_resolver.clean_captcha()
    captcha_resolver.extract_operation()
    captcha_resolver.extract_operation_numbers()
    return captcha_resolver.captcha_result()
